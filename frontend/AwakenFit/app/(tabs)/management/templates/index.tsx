    ...
    return (
        <SafeAreaProvider style={baseStyles.parent}>
            <SafeAreaView style={{
                ...
                <Text style={baseStyles.subHeader}>Manage Your Template Workouts</Text>
                <CustomButton text="Create Template" onPress={createPressed} disabled={false} />
                <CustomButton text="Template List" onPress={listPressed} disabled={false} />
            </SafeAreaView>
        </SafeAreaProvider>
    );
}
