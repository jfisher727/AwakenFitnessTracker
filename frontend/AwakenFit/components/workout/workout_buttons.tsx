        ...
        <View style={{ ...baseStyles.spacedRow, backgroundColor: "#ffffff" }}>
            {state.edit_movements ? (
                ...
                <Pressable
                    ...
                    disabled={!state.historical}
                >
                    <FontAwesome
                        size={28}
                        name="line-chart"
                        color={state.historical ? enabledColor : disabledColor}
                    />
                    <Text
                        style={{
                            color: state.end_workout
                                ? enabledColor
                                : disabledColor,
                        }}
                    >
            ...
            <Pressable
                ...
                disabled={!state.end_workout}
            >
                <FontAwesome
                    size={28}
                    name="stop-circle"
                    color={state.end_workout ? enabledColor : disabledColor}
                />
                <Text
                    style={{
                        color: state.end_workout ? enabledColor : disabledColor,
